...
def get_args():
  ...
  parser.add_argument("--prompt_style", type=str, default="original",
                      choices=['original', 'same_meaning', 'semantic', 'duplicate', 'fewshot'],
                      help="Prompt template style for paraphrase detection")
